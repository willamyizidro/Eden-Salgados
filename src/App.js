...
const App = () => {
  const links = [
    ...
    { name: "Loja 1 - Bairro: São Domingos", url: "https://wa.me/5511999550074", icon: faWhatsapp, className: "whatsapp" },
    { name: "Loja 2 - Bairro: São João - Rua Coqueiral", url: "https://wa.me/5511942103884", icon: faWhatsapp, className: "whatsapp" },
    { name: "Loja 3 - Bairro: São João - Estr. Guarulhos-Nazaré", url: "https://wa.me/5511984445583", icon: faWhatsapp, className: "whatsapp" },
    { name: "Loja 4 - Bairro: Jd São Domingos ", url: "https://wa.me/5511915736728", icon: faWhatsapp, className: "whatsapp" },
